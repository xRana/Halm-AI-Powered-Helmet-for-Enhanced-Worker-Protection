/**
 * Sheet Component - Halm Safety System
 * Fixed '@radix-ui/react-icons' error by switching to Lucide 'X' icon.
 * Optimized for clean side-panel interactions and consistent spacing.
 */
